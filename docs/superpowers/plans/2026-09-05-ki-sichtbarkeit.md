...
- [x] Sichtbare Zeile "Stand: TT.MM.JJJJ · Autor" (`partials/page-meta-line.njk`) unter der Hero-Subline auf FAQ, Glossar, Branchen-Hub und den fünf Branchenseiten, beide Sprachen, sowie auf jeder Wissen-Seite. Erledigt am 2026-09-09. Auf Pentesting und OT-Pentesting am 2026-09-11 wieder entfernt (Entscheidung André: keine Meta-Zeile im Hero der Service-Seiten); das `author`-Feld bleibt dort für das JSON-LD. Research-Notizen zeigen seit 2026-09-07 "Veröffentlicht" (und "Stand", sobald abweichend) als `<time>` in der Seitenleiste.
