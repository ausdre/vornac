...
- [x] Sichtbare Zeile "Stand: TT.MM.JJJJ · Autor" (`partials/page-meta-line.njk`) nur auf den Wissen-Seiten. Am 2026-09-09 auch auf Pentesting, OT-Pentesting, FAQ, Glossar, Branchen-Hub und den fünf Branchenseiten eingeführt, am 2026-09-11 dort wieder entfernt (Entscheidung André: keine Meta-Zeile im Hero außerhalb von Wissen); das `author`-Feld bleibt überall für das JSON-LD. Research-Notizen zeigen seit 2026-09-07 "Veröffentlicht" (und "Stand", sobald abweichend) als `<time>` in der Seitenleiste.
